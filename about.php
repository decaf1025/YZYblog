...
<body class="lightMode">
	...
	<div class="section sec-halfs bg-danger py-5">
		<div class="container">
			<div class="half-content d-lg-flex align-items-stretch">
				<div class="text">
					<h2 class="heading text-white mb-3">Resources for makers and creatives</h2>
					<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
					<p><a href="#" class="btn btn-outline-light py-2">Read more</a></p>
				</div>
			</div>

			<div class="half-content d-lg-flex align-items-stretch">
				<div class="text">
					<h2 class="heading text-white mb-3">We are trusted by more than 5,000 clients</h2>
					<p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
					<p><a href="#" class="btn btn-outline-light py-2">Read more</a></p>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row mb-5">
				<div class="col-lg-5 mx-auto text-center">
					<h2 class="heading text-white">Our Team</h2>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
				</div>
			</div>
	...
	<div class="section py-5">
		<div class="container">
			<div class="row justify-content-between">
				<div class="col-lg-7 mb-4 mb-lg-0">
					<img src="./devimg/20250614_224400.jpg" alt="Image" class="img-fluid rounded
					">
				</div>
				<div class="col-lg-4 ps-lg-2">
					<div class="mb-5">
						<h2 class="text-primary h4">Publishing platform for professional bloggers</h2>
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
					</div>
		...
		<div class="container">
				...
				<div class="col-lg-4">
					...
					<div class="widget">
						...
						<ul class="list-unstyled social">
							<li><a href="#" class="p-2"><i class="bi bi-facebook fs-1"></i></a></li>
							<li><a href="#" class="p-2"><i class="bi bi-twitter fs-1"></i></a></li>
							<li><a href="#" class="p-2"><i class="bi bi-instagram fs-1"></i></a></li>
							<li><a href="#" class="p-2"><i class="bi bi-youtube fs-1"></i></a></li>
						</ul>
					</div> <!-- /.widget -->
				</div> <!-- /.col-lg-4 -->
            ...
            <p>Copyright &copy; <strong class="text-primary px-1">YZYblog.</strong><script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed by <a href="https://untree.co">Decaf</a>
            </p>
          </div>
        </div>
    </footer>
